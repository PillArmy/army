...
public abstract class ArmyTestDataSupport {
    ...
    private static final List<String> PROVINCE_LIST = List.of(
    ...
    private static final List<String> PERSON_LIST = List.of(
    ...
    private static final List<String> NATION_LIST = List.of(
