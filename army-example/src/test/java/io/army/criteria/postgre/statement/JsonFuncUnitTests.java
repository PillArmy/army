    ...
    public void jsonBuildArrayFunc() {
        ...
        stmt = Postgres.query()
                .select(s -> s.space(jsonBuildArray(SQLs.literalValue(1), SQLs.literalValue("zoro"))::as, "json1")
                        ...
                        .comma(jsonBuildArray(space("b", DOT, ASTERISK))::as, "json10")
                        .comma(jsonbBuildArray(space("b", DOT, ASTERISK))::as, "json12")
...
/// @see Postgres#jsonbArrayElements(Expression)
    ...
    public void jsonArrayElementsFunc() {
        ...
        final Select stmt;
        stmt = Postgres.query()
                .selectDistinctOn(s -> s.accept(SQLs.refSelection("ordinal")), s -> s.space("json", DOT, ASTERISK)
                        .comma("jsonOrdinal", DOT, ASTERISK)
                )
...
/// @see Postgres#jsonbEach(BiFunction, Object)
    ...
    public void jsonEachFunc() {
        ...
        final Select stmt;
        stmt = Postgres.query()
                .select(s -> s.space("json", DOT, ASTERISK)
                        .comma("jsonOrdinal", DOT, ASTERISK)
                        .comma("jsonb", DOT, ASTERISK)
                        .comma("jsonbOrdinal", DOT, ASTERISK)
                )
    ...
    public void jsonbPathQueryFunc() {
        ...
        stmt = Postgres.query()
                .select(s -> s.space(jsonbPathQuery(jsonField, pathExp)::as, "json1")
                        ...
                        .comma("jt1", DOT, ASTERISK)
                        .comma("jt2", DOT, ASTERISK)
                        .comma("jt3", DOT, ASTERISK)
                        .comma("jt4", DOT, ASTERISK)
                        .comma("jt5", DOT, ASTERISK)
                        .comma("jt6", DOT, ASTERISK)
                        .comma("jt7", DOT, ASTERISK)
                        .comma("jt8", DOT, ASTERISK)
                        .comma("jt9", DOT, ASTERISK)
                        .comma("jt10", DOT, ASTERISK)
                        .comma("jt11", DOT, ASTERISK)
                        .comma("jt12", DOT, ASTERISK)
