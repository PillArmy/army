...
/// @see LabelEnumType
public class LabelEnumArrayType extends _ArmyCoreArrayType {
    ...
    static {
        addArrayFromFunc(LabelEnumArrayType.class, LabelEnumArrayType::from);
        addArrayFromParamFunc(LabelEnumArrayType.class, LabelEnumArrayType::fromParam);
    }
