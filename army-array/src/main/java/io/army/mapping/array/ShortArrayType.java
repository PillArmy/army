...
public class ShortArrayType extends _ArmyCoreArrayType {
    ...
    static {
        addArrayFromFunc(ShortArrayType.class, ShortArrayType::from);
    }
    ...
    public final Object afterGet(DataType dataType, MappingEnv env, Object source) throws DataAccessException {
        return PostgreArrays.arrayAfterGet(this, dataType, source, ShortArrayType::parseText, null);
    }
