...
/// @see Enum
/// @see NameEnumType
public class NameEnumArrayType extends _ArmyCoreArrayType {
    ...
    static {
        addArrayFromFunc(NameEnumArrayType.class, NameEnumArrayType::from);
        addArrayFromParamFunc(NameEnumArrayType.class, NameEnumArrayType::fromParam);
    }
