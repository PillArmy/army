...
public class LocalDateArrayType extends _ArmyCoreArrayType {
    ...
    static {
        addArrayFromFunc(LocalDateArrayType.class, LocalDateArrayType::from);
    }
    ...
    public final Object afterGet(DataType dataType, MappingEnv env, Object source) throws DataAccessException {
        return PostgreArrays.arrayAfterGet(this, dataType, source, LocalDateArrayType::parseText, null);
    }
