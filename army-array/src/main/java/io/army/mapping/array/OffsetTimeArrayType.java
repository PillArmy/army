...
public class OffsetTimeArrayType extends _ArmyCoreArrayType {
    ...
    static {
        addArrayFromFunc(OffsetTimeArrayType.class, OffsetTimeArrayType::from);
    }
