...
public class JsonbArrayType extends ArmyJsonArrayType {
    ...
    static {
        addArrayFromFunc(JsonbArrayType.class, JsonbArrayType::from);
        addArrayFromTypeArgFunc(JsonbArrayType.class, JsonbArrayType::fromTypeArg);
        addArrayFromTypeArgsFunc(JsonbArrayType.class, JsonbArrayType::fromTypeArgs);
    }
