            ...
            for (int i = 0; i < elementItemSize; i++) {
                ...
                if (element == null) {
                    ...
                    if (element instanceof Integer) {
                        context.appendLiteral(IntegerType.INSTANCE, element, false);
                    } else if (element instanceof String) {
                        context.appendLiteral(StringType.INSTANCE, element, false);
                    } else if ((type = _MappingFactory.getDefaultIfMatch(element.getClass())) == null) {
                        throw _Exceptions.notFoundMappingType(element);
                    } else {
                        context.appendLiteral(type, element, true);
                    }
