...
public interface InsertStatement extends DmlStatement {
    ...
    interface _ColumnDefaultClause<T> {
        ...
        _ColumnDefaultClause<T> defaultValue(FieldMeta<T> field, @Nullable Object value);

        <E> _ColumnDefaultClause<T> defaultValue(FieldMeta<T> field, BiFunction<FieldMeta<T>, E, Expression> operator, @Nullable E value);

        _ColumnDefaultClause<T> ifDefault(FieldMeta<T> field, @Nullable Object value);

        <E> _ColumnDefaultClause<T> ifDefault(FieldMeta<T> field, BiFunction<FieldMeta<T>, E, Expression> operator, @Nullable E value);
    }
