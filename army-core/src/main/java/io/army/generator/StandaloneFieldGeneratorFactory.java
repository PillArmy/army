...
public final class StandaloneFieldGeneratorFactory implements FieldGeneratorFactory {

    public static StandaloneFieldGeneratorFactory getInstance() {
        return new StandaloneFieldGeneratorFactory();
    }


    private StandaloneFieldGeneratorFactory() {
    }
