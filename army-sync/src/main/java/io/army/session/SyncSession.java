 ...
 * </ul>
 * <p>This interface's directly underlying api is {@link io.army.executor.SyncExecutor}.
...
public sealed interface SyncSession extends PackageSession, Closeable
     ...
     * <p>statement will be parsed as {@link io.army.stmt.Stmt} by {@link io.army.dialect.DialectParser} and {@link io.army.stmt.Stmt} will be executed by {@link io.army.executor.SyncExecutor}.
     *
     * <pre>
     ...
     *     <li>{@link io.army.executor.SyncExecutor} invoke consumer of {@link ResultStates} occur error, see {@link SyncStmtOption#stateConsumer()}</li>
