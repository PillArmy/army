...
abstract class PostgreDocumentFunctions extends PostgreMiscellaneous2Functions {
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/datatype-xml.html#id-1.5.7.21.6">XMLPARSE ( { DOCUMENT | CONTENT } value)
    /// </a>
    ...
    /// @param option {@link Postgres#DOCUMENT} or {@link Postgres#CONTENT}
    /// @see <a href="https://www.postgresql.org/docs/current/datatype-xml.html#id-1.5.7.21.6">XMLSERIALIZE ( { DOCUMENT | CONTENT } value AS type )
    /// </a>
    ...
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-PRODUCING-XML">Xmlforest
    /// </a>
    ...
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-PRODUCING-XML">9.15.1.3. Xmlelement
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-PRODUCING-XML">xmlpi ( NAME name [, content ] ) → xml
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-PRODUCING-XML">xmlroot ( xml, VERSION {text|NO VALUE} [, STANDALONE {YES|NO|NO VALUE} ] ) → xml
    /// </a>
    ...
    /// The {@link MappingType} of function return type: {@link  XmlType#TEXT}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-PRODUCING-XML">xmlagg ( xml ) → xml
    /// </a>
    ...
    /// The {@link MappingType} of function return type: {@link Boolean}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-XML-PREDICATES">xml_is_well_formed ( text ) → boolean
    /// </a>
    ...
    /// The {@link MappingType} of function return type: {@link Boolean}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-XML-PREDICATES">xml_is_well_formed_document ( text ) → boolean
    /// </a>
    ...
    /// The {@link MappingType} of function return type: {@link Boolean}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-xml.html#FUNCTIONS-XML-PREDICATES">xml_is_well_formed_content ( text ) → boolean
    /// </a>
    ...
    /// *
    /// 
    /// This method don't support {@link SQLs#space(String, SQLs.SymbolDot, TableMeta)},because it will output non-mapping column .
    /// you should use
    /// 
    /// - {@link #jsonBuildObject(String, SQLs.SymbolDot, TableMeta)}
    /// - {@link #jsonbBuildObject(String, SQLs.SymbolDot, TableMeta)}
    /// 
    /// *
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">array_to_json ( anyarray [, boolean ] ) → json
    ...
    /// 
    /// @throws CriteriaException throw when arg type error , but probably defer if arg is {@link SQLs#refField(String, String)}
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">row_to_json ( record [, boolean ] ) → json
    ...
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">json_build_array ( VARIADIC "any" ) → json
    ...
    /// 
    /// @throws CriteriaException throw when arg type error , but probably defer if arg is {@link SQLs#refField(String, String)}
    /// @see SQLs#space(String, SQLs.SymbolDot, SQLs.SymbolAsterisk)
    /// @see SQLs#space(String, SQLs.SymbolDot, TableMeta)
    /// @see #jsonBuildObject(String, SQLs.SymbolDot, TableMeta)
    /// @see #jsonbBuildObject(String, SQLs.SymbolDot, TableMeta)
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">json_build_array ( VARIADIC "any" ) → json
    /// Builds a possibly-heterogeneously-typed JSON array out of a variadic argument list. Each argument is converted as per to_json or to_jsonb.
    /// </a>
    ...
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">jsonb_build_array ( VARIADIC "any" ) → json
    /// Builds a possibly-heterogeneously-typed JSON array out of a variadic argument list. Each argument is converted as per to_json or to_jsonb.
    /// </a>
    ...
    public static SimpleExpression jsonBuildObject(String tableAlias, SQLs.SymbolDot period, TableMeta<?> table) {
        return FunctionUtils.oneArgObjectElementFunc("json_build_object", ContextStack.peek().row(tableAlias, period, table));
    }

    public static SimpleExpression jsonBuildObject(String derivedAlias, SQLs.SymbolDot period, SQLs.SymbolAsterisk asterisk) {
    ...
    /// 
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">json_build_object ( VARIADIC "any" ) → json
    /// Builds a possibly-heterogeneously-typed JSON array out of a variadic argument list. Each argument is converted as per to_json or to_jsonb.
    /// </a>
    ...
    public static SimpleExpression jsonbBuildObject(String tableAlias, SQLs.SymbolDot period, TableMeta<?> table) {
        return FunctionUtils.oneArgObjectElementFunc("jsonb_build_object", ContextStack.peek().row(tableAlias, period, table));
    }

    public static SimpleExpression jsonbBuildObject(String derivedAlias, SQLs.SymbolDot period, SQLs.SymbolAsterisk asterisk) {
    ...
    /// - {@link SQLs#space(String, SQLs.SymbolDot, TableMeta)}
    /// 
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">jsonb_build_object ( VARIADIC "any" ) → json
    /// Builds a possibly-heterogeneously-typed JSON array out of a variadic argument list. Each argument is converted as per to_json or to_jsonb.
    /// </a>
    ...
    /// The {@link MappingType} of function return type: {@link JsonType#TEXT}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">json_object ( text[] ) → json
    ...
    /// The {@link MappingType} of function return type: {@link JsonbType#TEXT}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">jsonb_object ( text[] ) → json
    /// Builds a JSON object out of a text array. The array must have either exactly one dimension with an even number of members, in which case they are taken
    /// as alternating key/value pairs, or two dimensions such that each inner array has exactly two elements, which are taken as a key/value pair. All values are
    /// converted to JSON strings.
    /// </a>
    ...
    /// The {@link MappingType} of function return type: {@link JsonType#TEXT}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">json_object ( keys text[], values text[] ) → json
    ...
    /// The {@link MappingType} of function return type: {@link JsonbType#TEXT}
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-CREATION-TABLE">jsonb_object ( keys text[], values text[] ) → json
    /// This form of json_object takes keys and values pairwise from separate text arrays. Otherwise it is identical to the one-argument form.
    /// json_object('{a,b}', '{1,2}') → {"a": "1", "b": "2"}
    /// </a>
    ...
    /// *
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">json_array_length ( json ) → integer
    ...
    /// The {@link MappingType} of function return type: {@link IntegerType}.
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_array_length ( json ) → integer
    /// Returns the number of elements in the top-level JSON array.
    /// </a>
    ...
    /// 
    /// The {@link MappingType} of fields of derived table :
    /// - fields follow {@link MappingType.SqlComposite#fieldList()}
    /// - ordinality (optioinal) : {@link IntegerType}. see {@link _WithOrdinalityClause#withOrdinality()}
    /// 
    /// @param base composite type expression.
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">json_populate_record ( base anyelement, from_json json ) → anyelement
    /// 
    /// </a>
    ...
    /// *
    /// @param base composite type expression.
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_populate_record ( base anyelement, from_json json ) → anyelement
    /// 
    /// </a>
    ...
    /// 
    /// @param base composite type expression.
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">json_populate_recordset ( base anyelement, from_json json ) → anyelement
    /// 
    /// </a>
    ...
    /// 
    /// @param base composite type expression.
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_populate_recordset ( base anyelement, from_json json ) → anyelement
    /// 
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_set ( target jsonb, path text[], new_value jsonb [, create_if_missing boolean ] ) → jsonb
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_set_lax ( target jsonb, path text[], new_value jsonb [, create_if_missing boolean [, null_value_treatment text ]] ) → jsonb
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_insert ( target jsonb, path text[], new_value jsonb [, insert_after boolean ] ) → jsonb
    /// </a>
    ...
    /// @throws CriteriaException throw when argument isn't operable {@link Expression},for example {@link SQLs#DEFAULT},
    /// {@link SQLs#rowParam(TypeInfer, Collection)}
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">json_strip_nulls ( json ) → json
    /// </a>
    ...
    /// @throws CriteriaException throw when argument isn't operable {@link Expression},for example {@link SQLs#DEFAULT},
    /// {@link SQLs#rowParam(TypeInfer, Collection)}
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_strip_nulls ( jsonb ) → jsonb
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_exists ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → boolean
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_match ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → boolean
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_query_array ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → jsonb
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_query_first ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → jsonb
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_exists_tz ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → boolean
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_match_tz ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → boolean
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_query_array_tz ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → jsonb
    /// </a>
    ...
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_path_query_first_tz ( target jsonb, path jsonpath [, vars jsonb [, silent boolean ]] ) → jsonb
    /// </a>
    ...
    /// @throws CriteriaException throw when argument isn't operable {@link Expression},for example {@link SQLs#DEFAULT},
    /// {@link SQLs#rowParam(TypeInfer, Collection)}
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_pretty ( jsonb ) → text
    /// </a>
    ...
    /// @throws CriteriaException throw when argument isn't operable {@link Expression},for example {@link SQLs#DEFAULT},
    /// {@link SQLs#rowParam(TypeInfer, Collection)}
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">json_typeof ( json ) → text
    /// </a>
    ...
    /// @throws CriteriaException throw when argument isn't operable {@link Expression},for example {@link SQLs#DEFAULT},
    /// {@link SQLs#rowParam(TypeInfer, Collection)}
    /// @see <a href="https://www.postgresql.org/docs/current/functions-json.html#FUNCTIONS-JSON-PROCESSING-TABLE">jsonb_typeof ( json ) → text
    /// </a>
