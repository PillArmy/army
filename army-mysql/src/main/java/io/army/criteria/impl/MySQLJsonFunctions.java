...
abstract class MySQLJsonFunctions extends MySQLTimeFunctions {
    ...
    /// JSON_ARRAY function variadic method.
    /// The {@link MappingType} of function return type: {@link JsonType#TEXT}
    ...
    /// JSON_ARRAY function static method.
    /// The {@link MappingType} of function return type: {@link JsonType#TEXT}
    ...
    /// JSON_ARRAY function dynamic method.
    /// The {@link MappingType} of function return type: {@link JsonType#TEXT}
    ...
    /// 
    /// - {@link Expression} instance
    /// - the instance that  can be accepted by {@link JsonType#TEXT},here it will output literal. For example : {@code "[1,2]"} is equivalent to {@code SQLs.literal(JsonType.TEXT,"[1,2]") }
    /// 
    ...
    /// 
    /// - {@link Expression} instance
    /// - {@link String} literal. For example : {@code "$[*]"} is equivalent to {@code SQLs.literal(StringType.INSTANCE,"$[*]") }
    /// 
    /// @throws CriteriaException throw when argument error
    ...
    /// - the instance that  can be accepted by {@link JsonType#TEXT},here it will output literal. For example : {@code "[1,2]"} is equivalent to {@code SQLs.literal(JsonType.TEXT,"[1,2]") }
    /// 
    /// @param oneOrAll one of following
    /// - literal 'one' or 'all'
    /// - {@link Expression}
    /// 
    ...
    /// 
    /// - {@link Expression} instance
    /// - {@link String} instance. For example : {@code "$[*]"} is equivalent to {@code SQLs.literal(StringType.INSTANCE,"$[*]") }
    /// 
    /// @throws CriteriaException throw when argument error
    ...
    /// 
    /// - If don't specified RETURNING clause then {@link StringType}
    /// - Else if type is {@link MySQLCastType#CHAR }then {@link StringType}
    /// - Else if type is {@link MySQLCastType#TIME }then {@link LocalTimeType}
    /// - Else if type is {@link MySQLCastType#DATE }then {@link LocalDateType}
    ...
    /// - Else if type is {@link MySQLCastType#JSON }then {@link JsonType#TEXT}
    /// , it's up to RETURNING clause.
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    /// - the instance that  can be accepted by {@link JsonType#TEXT},here it will output literal. For example : {@code "[1,2]"} is equivalent to {@code SQLs.literal(JsonType.TEXT,"[1,2]") }
    ...
    /// JSON_ARRAY_APPEND function static method
    ...
    /// JSON_ARRAY_APPEND function dynamic method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_ARRAY_INSERT function static method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_ARRAY_INSERT function dynamic method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_INSERT function static method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_INSERT function dynamic method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_REPLACE function static method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_REPLACE function dynamic method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_SET function static method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// JSON_SET function dynamic method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc  json expression
    /// 
    /// - {@link Expression} instance
    ...
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// You should use {@link #jsonMergePreserve(Object, Object, Object...)},if database is 8.0+.
    /// @param jsonDoc1 json expression
    /// 
    /// - {@link Expression} instance
    /// - the instance that  can be accepted by {@link JsonType#TEXT},here it will output literal. For example : {@code "[1,2]"} is equivalent to {@code SQLs.literal(JsonType.TEXT,"[1,2]") }
    ...
    /// JSON_REMOVE function dynamic method
    /// The {@link MappingType} of function return type:the {@link MappingType} of jsonDoc
    /// @param jsonDoc json expression
    /// 
    /// - {@link Expression} instance
